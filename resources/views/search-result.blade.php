...
<!-- ============================================== COLOR: END ============================================== -->
	...
	<div class="product">		
		<div class="product-image">
			<div class="image">
				<a href="product-details.php?pid="><img  src="assets/images/blank.gif" data-echo="admin/productimages/" alt="" width="200" height="300"></a>
			</div><!-- /.image -->			                      		   
		</div><!-- /.product-image -->
				...
				<div class="action">
					<ul class="list-unstyled">
		                ...
		                <li class="lnk wishlist">
							<a class="add-to-cart" href="category.php?pid=&&action=wishlist" title="Wishlist">
