				...
				<tr>
					...
					<td class="cart-image">
						<a class="entry-thumbnail" href="detail.html">
						    <img src="admin/productimages/" alt="" width="114" height="146">
						</a>
					</td>
					<td class="cart-product-name-info">
						<h4 class='cart-product-description'><a href="product-details.php?pid=" ></a></h4>
						<div class="row">
							<div class="col-sm-4">
...
<td class="cart-product-sub-total"><span class="cart-sub-total-price">.00</span></td>
					...
					<td class="cart-product-grand-total"><span class="cart-grand-total-price">.00</span></td>
				</tr>
